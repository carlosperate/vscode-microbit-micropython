...
🚧 This extension is under construction. Already implemented features should be
...
- **Direct Flash:** Send the built MicroPython hex to a connected micro:bit over
  WebUSB, in a Chromium based browser.
  Desktop VS Code cannot pair a board yet, so use **Save Hex** there instead.
...
| Desktop VS Code | ❌ not yet, use Save Hex meanwhile | ✅ native serial port | ✅ |
...
- VS Code desktop or, or if used in the browser, a Chromium-based one for
